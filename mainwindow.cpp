...

{
   ...
   // connect(ui->Change_Font_Style,&QAction::trigerred,this,&MainWindow::change_font_style_slot);
...
{
   QStringList = styles;
   styles<<tr("TimesNewRoman")<<tr("Ubuntu");

}*/
/*void MainWindow::change_font_size()
{
    setter->setFontSize();
}*/
